...
from src.api.common.utils import out_path_from_request_id, request_data_dir_from_id, request_out_dir_from_id
...
class BaseHandler:
    ...
    async def handle(self, helpers: "HelpersHandler", request_id: str, raw_file_path: Path) -> RequestProcessCodes:
